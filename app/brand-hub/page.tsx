...
import { BrandHubPageSettingsModal } from '@/components/brand-hub/BrandHubPageSettingsModal';
...
export default function BrandHubPage() {
  const { resources, isLoaded, addResource, deleteResource, updateResource, getCategories } = useResources();
