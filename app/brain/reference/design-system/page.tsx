...
export default function DesignSystemPage() {
  ...
  useEffect(() => {
    fetch('/api/claude/reference/design-system.md')
      .then(res => {
      ...
      .catch(err => {
        ...
        setContent('# Design System\n\nDesign system documentation not yet configured. Create `.claude/reference/design-system.md` to display content here.');
      });
  }, []);
          ...
          <MotionItem className="flex flex-col gap-2 mb-10">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <Settings className="w5 h-5 text-[var(--fg-tertiary)] group-hover:text-[var(--fg-brand-primary)] transition-colors" />
                </button>
              </div>
            </div>
            <p className="text-base md:text-lg text-[var(--fg-tertiary)] max-w-2xl">
              UI components and patterns documentation for consistent design implementation.
            </p>
          </MotionItem>
