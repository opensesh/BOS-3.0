...
export default function DataSourcesPage() {
  ...
  useEffect(() => {
    fetch('/api/claude/data/news-sources.md')
      .then(res => {
      ...
      .catch(err => {
        ...
        setContent('# Data Sources\n\nData sources documentation not yet configured. Create `.claude/data/news-sources.md` to display content here.');
      });
  }, []);
        ...
        <PageTransition className="w-full max-w-6xl mx-auto px-6 py-8 md:px-12 md:py-12">
          ...
          <MotionItem className="flex flex-col gap-2 mb-10">
            ...
            <p className="text-base md:text-lg text-[var(--fg-tertiary)] max-w-2xl">
              Reference data and external sources for content curation and research.
            </p>
          </MotionItem>
