...
export default function ChatsPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-56px)] lg:min-h-[calc(100vh-48px)] bg-[var(--bg-primary)]">
      <div className="max-w-4xl mx-auto px-4 py-6 lg:py-8">
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-semibold text-[var(--fg-primary)]">Recent Chats</h1>
          ...
          <button
            ...
            "
          >
            <Plus className="w-4 h-4 text-[var(--fg-brand-primary)]" />
            <span>New Chat</span>
          </button>
        </div>
