...
export const BRAND_SOURCES: Record<string, { id: string; name: string; title: string; path: string; snippet: string; href: string; tab?: string }> = {
  brand_identity: {
    ...
    path: '/.claude/brand-identity/OS_brand identity.md',
  ...
  brand_messaging: {
    ...
    path: '/.claude/brand-identity/OS_brand messaging.md',
  ...
  art_direction: {
    ...
    path: '/.claude/brand-identity/OS_art direction.md',
  ...
  writing_short: {
    ...
    path: '/.claude/writing-styles/short-form.md',
  ...
  writing_long: {
    ...
    path: '/.claude/writing-styles/long-form.md',
  ...
  writing_blog: {
    ...
    path: '/.claude/writing-styles/blog.md',
  ...
  writing_creative: {
    ...
    path: '/.claude/writing-styles/creative.md',
  ...
  writing_strategic: {
    ...
    path: '/.claude/writing-styles/strategic.md',
