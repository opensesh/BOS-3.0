...
export function AnimatedFolder({
  ...
  return (
    <motion.button
      ...
      className="group relative w-full h-full rounded-2xl bg-[var(--bg-secondary)] border border-[var(--border-primary)] p-4 cursor-pointer text-left transition-all duration-300 hover:border-[var(--border-brand)]"
      whileTap={{ scale: 0.98 }}
    >
      ...
      <div className="flex flex-col h-full">
        ...
        {/* 3D Folder - BOTTOM - Fixed 48x48 size */}
        <div 
