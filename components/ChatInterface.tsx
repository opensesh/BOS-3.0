...
export function ChatInterface() {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-0 z-10 flex flex-col lg:left-[var(--sidebar-width)] transition-[left] duration-200 ease-out ${hasMessages ? '' : 'items-center justify-center pt-20 pb-8'}`}>
        {/* Chat Mode */}
        {hasMessages && (
