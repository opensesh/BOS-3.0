...
export const BRAND_SOURCES: Record<string, { id: string; name: string; title: string; path: string; snippet: string; href: string; tab?: string }> = {
  ...
  writing_short: {
    ...
    path: '/.claude/brand/writing/short-form.md',
  ...
  writing_long: {
    ...
    path: '/.claude/brand/writing/long-form.md',
  ...
  writing_blog: {
    ...
    path: '/.claude/brand/writing/blog.md',
  ...
  writing_creative: {
    ...
    path: '/.claude/brand/writing/creative.md',
  ...
  writing_strategic: {
    ...
    path: '/.claude/brand/writing/strategic.md',
