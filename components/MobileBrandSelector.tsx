    ...
    <>
      <div className="relative flex-1">
        ...
        >
          {/* Logo + Brand Name */}
            ...
            <span className="text-[var(--fg-primary)] font-medium text-sm truncate">
              {selectedBrand.name}
            </span>
          </div>
      ...
      {showAddModal && (
        ...
        >
          <div
            className="
              bg-[var(--bg-secondary)] rounded-lg border border-[var(--border-secondary)]
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="
                    ...
                    rounded-lg text-[var(--fg-primary)]
              ...
              <div>
                ...
                <div
                  ...
                  "
                >
                  <Upload className="w-8 h-8 text-[var(--fg-secondary)] mb-2" />
                  <p className="text-sm text-[var(--fg-primary)] mb-1">
                    ...
                    {uploadedFiles.map((file, index) => (
                      ...
                      >
                        <div className="flex items-center space-x-2 flex-1 min-w-0">
                          <ImageIcon className="w-4 h-4 text-[var(--fg-secondary)] flex-shrink-0" />
                ...
                <div className="mt-4 pt-4 border-t border-[var(--border-secondary)]">
                  <p className="text-xs font-medium text-[var(--fg-secondary)] mb-3 uppercase tracking-wider">
                    Recommended Assets
                  </p>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="flex items-center space-x-2 px-3 py-2 bg-[var(--bg-tertiary)] rounded-lg border border-[var(--border-secondary)]">
                      <FileText className="w-4 h-4 text-[var(--fg-secondary)]" />
                      <span className="text-xs text-[var(--fg-secondary)]">Brand Guidelines</span>
                    </div>
                    <div className="flex items-center space-x-2 px-3 py-2 bg-[var(--bg-tertiary)] rounded-lg border border-[var(--border-secondary)]">
                      <ImageIcon className="w-4 h-4 text-[var(--fg-secondary)]" />
                      <span className="text-xs text-[var(--fg-secondary)]">Logos</span>
                    </div>
                    <div className="flex items-center space-x-2 px-3 py-2 bg-[var(--bg-tertiary)] rounded-lg border border-[var(--border-secondary)]">
                      <Palette className="w-4 h-4 text-[var(--fg-secondary)]" />
                      <span className="text-xs text-[var(--fg-secondary)]">Design Tokens</span>
                    </div>
                    <div className="flex items-center space-x-2 px-3 py-2 bg-[var(--bg-tertiary)] rounded-lg border border-[var(--border-secondary)]">
                      <FileText className="w-4 h-4 text-[var(--fg-secondary)]" />
                      <span className="text-xs text-[var(--fg-secondary)]">Typography</span>
                    </div>
                  </div>
                </div>
              </div>
